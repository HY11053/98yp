...
class ListNewsController extends Controller
{
    ...
    public function listNews(Request $request,$path,$page=0)
    {
        ...
        if(Arctype::where('id',$typeid)->value('mid')==0)
        {
            ...
            return view('frontend.index_lists',compact('thistypeinfo','pagelists','cnewtop','cnewtops','topbrands','latestbrands','latesenews','sontypes','hnewtops'));
        }elseif (Arctype::where('id',$typeid)->value('mid')==1)
        {
            ...
            $latesenews=Archive::where('typeid','<>',$thistypeinfo->id)->take(7)->latest()->get();
            return view('frontend.brands',compact('thistypeinfo','topbrandnavs','pagelists','topbrands','cnewslists','latesenews','lastestbrands'));
        }
