...
class IndexController extends Controller
{
    function Index()
    {
        ...
        $flinks=flink::all();
        return view('frontend.index',compact('cbrands','abrands','paihangbangs','latestbrands','yinpinjmtypes','yphynews','ypasks','anlinews','yinpintypes','lirunnews','feiyongnews','ppxwnews','hbrands','flinks'));
    }
