        ...
        <div class="container-fluid list_clear">
            <div clas="row">
                ...
                <div class="col-xs-12 text-center list_clear list_margin">
                    <dl>
                        <dt class="col-xs-4 list_clear "><a class="img_a" href="/{{$pagelist->arctype->real_path}}/{{$pagelist->id}}.html">{{$pagelist->brandname}}<img class=""  style="padding-top:14px;" src="{{$pagelist->litpic}}"  alt="{{$pagelist->brandname}}" /></a></dt>
